...
import 'piccolore';
import { P as createRenderInstruction, x as maybeRenderHead, a2 as addAttribute, L as renderTemplate, aX as renderHead, aR as renderSlot } from './sequence_CwIBq7rn.mjs';
